...
<button onclick="slot()">Крутить</button>
</div>
...
<h3>🎁 Daily</h3>
<p id="dailyText"></p>
<button onclick="daily()">Забрать</button>
</div>
</div>
...
if(res[0]==res[1]&&res[1]==res[2]) win=bet*10;
else if(res[0]==res[1]||res[1]==res[2]) win=bet*3;
...
let reward=2000+user.streak*500;
